#!/usr/bin/env python3
"""
Script para convertir el documento Markdown a Word (.docx) y PDF
"""
...
def install_requirements():
    ...
    try:
        ...
        subprocess.check_call([
            ...
            "markdown", "python-docx", "weasyprint", "beautifulsoup4"
        ])
...
def html_to_pdf(html_content, output_file):
    ...
    try:
        ...
        print("💡 Asegúrate de tener WeasyPrint instalado correctamente")
...
def main():
    """Función principal"""
    print("🚀 Iniciando conversión de documentos...")
