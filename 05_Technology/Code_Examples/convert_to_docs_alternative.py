#!/usr/bin/env python3
"""
Script alternativo para convertir el documento Markdown a Word (.docx) y PDF
Usa reportlab en lugar de WeasyPrint para evitar problemas de dependencias en macOS
"""
...
def markdown_to_html(md_file):
    ...
    <head>
        ...
        <title>Frases Populares de Búsqueda en Google 2024</title>
        <style>
            body {{
...
def markdown_to_docx(md_file, output_file):
    """Convierte Markdown a Word (.docx)"""
    ...
    if 'Título 1' not in [style.name for style in styles]:
        ...
        title1_font.color.rgb = None  # Color por defecto
    ...
    while i < len(lines):
        ...
        if line.startswith('# '):
            ...
            # Lista numerada
            items = []
            while i < len(lines) and (lines[i].strip()[0].isdigit() and '. ' in lines[i].strip()):
                item = lines[i].strip()
...
def main():
    """Función principal"""
    print("🚀 Iniciando conversión de documentos (versión alternativa)...")
    
    # Instalar dependencias
    install_requirements()
    
    # Archivos de entrada y salida
    md_file = "/Users/adan/frontier/frases-populares-busqueda-google-2024.md"
    html_file = "/Users/adan/frontier/frases-populares-busqueda-google-2024.html"
    docx_file = "/Users/adan/frontier/frases-populares-busqueda-google-2024.docx"
    pdf_file = "/Users/adan/frontier/frases-populares-busqueda-google-2024.pdf"
