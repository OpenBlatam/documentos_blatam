#!/usr/bin/env python3
"""
Script simple para convertir documentos legales Markdown a PDF
Usa markdown2 y reportlab para máxima compatibilidad
"""
...
class SimpleLegalPDFConverter:
    ...
    def convert_markdown_to_elements(self, markdown_file):
        ...
        # Convertir HTML a elementos de ReportLab
        elements = []
    ...
    def add_header_footer(self, canvas, doc):
        ...
        canvas.drawCentredText(A4[0]/2, 50, f"Página {doc.page} - {datetime.now().strftime('%d/%m/%Y')}")
    ...
    def convert_all_documents(self):
        ...
        for md_file in markdown_files:
            if md_file.name.startswith("00_") or md_file.name == "README.md":
                continue
...
def main():
    """Función principal"""
    print("🚀 CONVERTIDOR SIMPLE DE DOCUMENTOS LEGALES A PDF")
    print("=" * 60)
    ...
    # Crear convertidor
    converter = SimpleLegalPDFConverter()
