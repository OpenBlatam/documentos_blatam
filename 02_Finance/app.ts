...
import advancedDataVisualizationRoutes from './routes/advancedDataVisualization';
import advancedAPIGatewayRoutes from './routes/advancedAPIGateway';
import { 
...
// Rutas de visualización de datos avanzada
app.use('/api/data-visualization', 
  validateAnalyticsAccess,
  advancedDataVisualizationRoutes
);

// Rutas de API Gateway avanzado
app.use('/api/gateway', 
  validateAnalyticsAccess,
  advancedAPIGatewayRoutes
);
...
app.use('*', (req, res) => {
  res.status(404).json({
    ...
    availableRoutes: [
      ...
      'GET /api/data-visualization/visualizations',
      'POST /api/data-visualization/visualizations',
